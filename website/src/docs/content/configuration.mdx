...
storage:
  ...
  local:
    ...
    vacuum:
      ...
      compress_quality: 40
      delete_after_days: 0             # 0 disables deletion
...
| **Always-on, minimal disk** | `screenshot_quality: 35`, `screenshot_max_dim: 900`, `vacuum.compress_after_days: 7`, `vacuum.delete_after_days: 60`. |
