...
- **Built-in widgets** (`list`, `json`) cover the
...
Domain-specific intelligence from your own bespoke watchers gets a first-class
...
Beside (anything custom you ship) are visible instead
