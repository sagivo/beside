...
const outRoot = path.join(repoRoot, 'packages', 'desktop', 'build', 'resources', 'cofounderos');
...
await fs.writeFile(
  ...
  'CofounderOS runtime resources. Generated by packages/desktop/scripts/prepare-package-resources.mjs.\n',
  'utf8',
);
